...
const EXPECTED = {
  de: {
    ...
    'Track token usage': 'Tokenverbrauch erfassen',
    'Token statistics': 'Tokenstatistik',
  ...
  fr: {
    ...
    'Track token usage': 'Suivre les jetons',
    'Token statistics': 'Statistiques de jetons',
  ...
  it: {
    ...
    'Track token usage': 'Registra utilizzo token',
    'Token statistics': 'Statistiche token',
  ...
  es: {
    ...
    'Track token usage': 'Registrar uso de tokens',
    'Token statistics': 'Estadísticas de tokens',
